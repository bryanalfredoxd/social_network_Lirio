...
if ($resultado_comentarios->num_rows > 0) {
    while ($comentario = $resultado_comentarios->fetch_assoc()) {
        ...
        echo "<div class='comentario card mb-3 p-3' onclick=\"window.location.href='../controllers/publicacion_detalle.php?post_id=" . $comentario['proyecto_id'] . "'\" style='cursor: pointer; max-width: 600px; margin: 0 auto;'>"; // Uso de tarjeta de Bootstrap
